%% This code runs simulation over permutations of elasticities with no reallocation
...
step_size = 4; %number of years for shock
...
toc
parfor_progress(0);
correct = (GDP~=0 & log(GDP)>-.8 & log(GDP) <.3); % Only use GDP values that are not caused by numerical errors
...
cd(sprintf('%s%g%s', 'C:\Users\Baqaee\Dropbox\Work\Hultens Theorem\Calibration\GDP Simulatin -- 88 Sector\Robustness\',step_size,' year\No Reallocation'))
