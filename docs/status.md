...
<!-- volatile:start -->
Generated 2026-09-17 by `scripts/status.jl` · branch `reorg` · HEAD `de947da` (clean)
Generated 2026-09-17 by `scripts/status.jl` · branch `reorg` · HEAD `6d66265` (dirty)
<!-- volatile:end -->
...
| matrix_5x3-BETA-F1 | BETA | F1 | planned | eta=1.0, eta_s=0.5, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
| matrix_5x3-BETA-F2 | BETA | F2 | planned | eta=1.0, eta_s=0.5, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
| matrix_5x3-BETA-F3 | BETA | F3 | planned | eta=1.0, eta_s=0.5, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
| matrix_5x3-BF-F1 | BF | F1 | planned | eta=0.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned; matrix not yet implemented; cbase2 pipeline map lists notebooks 04-08 that do not exist [cbase2/documentation.md] |
| matrix_5x3-BF-F2 | BF | F2 | planned | eta=0.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
| matrix_5x3-BF-F3 | BF | F3 | planned | eta=0.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
...
| matrix_5x3-GAMMA-F1 | GAMMA | F1 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
| matrix_5x3-GAMMA-F2 | GAMMA | F2 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
| matrix_5x3-GAMMA-F3 | GAMMA | F3 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (preregistered 2026-09-17); planned |
...
| cbase2 | submission-snapshot | frozen | 6d66265 | 46 | 8a28d1e | Self-contained cbase2 pipeline for the Metroeconomica revision (5 x 3 evaluation matrix; cbase2/documentation.md). At freeze: notebooks 01-02 complete and validated end-to-end; notebook 03 plus src/financing.jl complete and smoke-tested at m = 1 with two recorded kernel DIFFs; notebooks 04-08 and src/validation.jl listed as pending. |
  ...
  - open: F3 mobile solve stalls at max residual ~2e-4; the BETA eta-continuation ran >25 min without completing. Root-kernel status (ADR-0010): the stall is the review section 4 conditioning/fold problem, not the equation count; measured 4.3e-4 on the real 70-sector calibration at the reference rung (both N-1+CPI and all-N formulations)
