# ═══════════════════════════════════════════════════════════════════════════════
# cbase2 labour closures (Foundation I, Stage 1.2–1.3) — src/closures.jl
# ═══════════════════════════════════════════════════════════════════════════════
#
# cbase2-only file. Adds the two missing labour closures of the 5 x 3 matrix:
#
...
#   `leontief_multiplier` and used in notebook 04 as the equivalence test.
# ═══════════════════════════════════════════════════════════════════════════════
...
results are insensitive to `ε` up to O(ε) — asserted in notebook 04.
"""
...
`process_comments.md`), and a fold blocks step-wise progress while a larger
...
export ElasticLaborClosure, labor_market_residual, delta_elasticities,
	delta_model, leontief_multiplier, solve_beta, solve_verified