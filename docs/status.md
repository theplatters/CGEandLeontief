...
<!-- volatile:start -->
Generated 2026-09-17 by `scripts/status.jl` · branch `reorg` · HEAD `60c2665` (dirty)
<!-- volatile:end -->
...
| run_id | labour | financing | status | parameters | evidence | notes |
| --- | --- | --- | --- | --- | --- | --- |
| matrix_5x3-ALPHA-F1 | ALPHA | F1 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-ALPHA-F2 | ALPHA | F2 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-ALPHA-F3 | ALPHA | F3 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-BETA-F1 | BETA | F1 | planned | eta=1.0, eta_s=0.5, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-BETA-F2 | BETA | F2 | planned | eta=1.0, eta_s=0.5, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-BETA-F3 | BETA | F3 | planned | eta=1.0, eta_s=0.5, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-BF-F1 | BF | F1 | planned | eta=0.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-BF-F2 | BF | F2 | planned | eta=0.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-BF-F3 | BF | F3 | planned | eta=0.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-DELTA-F1 | DELTA | F1 | planned | eta=1.0, eta_s=0, theta=1e-4, epsilon=1e-4, sigma=1e-4 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned \| theta/epsilon/sigma = delta_epsilon = 1e-4 (the solved Leontief-limit values; ADR-0006) |
| matrix_5x3-DELTA-F2 | DELTA | F2 | planned | eta=1.0, eta_s=0, theta=1e-4, epsilon=1e-4, sigma=1e-4 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned \| theta/epsilon/sigma = delta_epsilon = 1e-4 (the solved Leontief-limit values; ADR-0006) |
| matrix_5x3-DELTA-F3 | DELTA | F3 | planned | eta=1.0, eta_s=0, theta=1e-4, epsilon=1e-4, sigma=1e-4 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned \| theta/epsilon/sigma = delta_epsilon = 1e-4 (the solved Leontief-limit values; ADR-0006) |
| matrix_5x3-GAMMA-F1 | GAMMA | F1 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-GAMMA-F2 | GAMMA | F2 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
| matrix_5x3-GAMMA-F3 | GAMMA | F3 | planned | eta=1.0, eta_s=0, theta=0.5, epsilon=0.5, sigma=0.9 |  | parameters pinned in experiments/designs/matrix_5x3.toml (full-71 A-bill, ADR-0012); planned |
